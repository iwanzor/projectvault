...
export default function PayablesPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Payable transaction created");
      setFormOpen(false);
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["payables"] });
      queryClient.invalidateQueries({ queryKey: ["payables-summary"] });
      toast.success("Payable transaction updated");
      setFormOpen(false);
      setEditingTransaction(null);
    },
    onError: (error: Error) => toast.error(error.message),
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Account Payables</h1>
      ...
      {summary && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 p-3">
            <p className="text-xs text-zinc-500">Total Left</p>
      ...
      <DataTable
        ...
        isLoading={isLoading}
        emptyMessage="No payable transactions found."
      ...
      <TransactionForm
        ...
        title={editingTransaction ? "Edit Payable Transaction" : "New Payable Transaction"}
        defaultValues={
          editingTransaction
            ? {
