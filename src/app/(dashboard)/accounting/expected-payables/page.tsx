...
export default function ExpectedPayablesPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Expected Payables</h1>
          <p className="text-sm text-zinc-500">
            {transactions.length} upcoming payments
          </p>
        </div>
      </div>
      ...
      <DataTable
        ...
        isLoading={isLoading}
        emptyMessage="No expected payables found."
